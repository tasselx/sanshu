...
import AttachmentSettings from '../settings/AttachmentSettings.vue'
...
<template>
  <div class="max-w-3xl mx-auto tab-content">
    <n-collapse size="large" :default-expanded-names="[]" arrow-placement="right">
      ...
      <!-- 附件工作目录 -->
      <n-collapse-item name="attachment">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-pink-100 dark:bg-pink-900 flex items-center justify-center mr-4">
                <div class="i-carbon-folder-details text-lg text-pink-600 dark:text-pink-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  附件工作目录
